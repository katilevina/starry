> **⚠️ SYNC RULE:** This template must be kept in sync with `.claude/skills/job-analysis/references/role_profile_template.md`
...
[Brief summary of what this role type is about — 2-3 sentences]
